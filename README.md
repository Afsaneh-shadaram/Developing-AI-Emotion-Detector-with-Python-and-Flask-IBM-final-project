# IBM final project "Emotion Detection application":
   ...
   ## 1- Introduction
   This project is the final project for the IBM course "Developing AI Applications with Python and Flask". For more information about the course refer to this link <>.
  ...
  ## 4- Web deployment of the application using Flask with error handling
   ...
   ### The output of deployed app on the localhost:5000
...
<img width="761" height="735" alt="Final output in Flask" src="https://github.com/user-attachments/assets/22593aee-daa9-48ad-863f-056bf9174fcd" />
   ...
   ### The output of deployed app with error handling when there is not input
